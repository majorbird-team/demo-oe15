...
class PurchaseOrderLine(models.Model):
    ...
    offset_qty_received = fields.Float(string="Offset Quantity Received")
    offset_qty_invoiced = fields.Float(string="Offset Quantity Billed")

    @api.depends('move_ids.state', 'move_ids.product_uom_qty', 'move_ids.product_uom', 'offset_qty_received')
